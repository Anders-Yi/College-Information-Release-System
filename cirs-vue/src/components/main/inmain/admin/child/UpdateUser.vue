<template>
  <div id="adduser">
    <div class="updateuser-card">
      <div class="updateuser-title">修改用户信息</div>
      <span class="close" @click="closeUpdateUser">X</span>
      <form action="#" method="post" class="form-table">
        ...
        <input type="button" @click="submitUpdateUser" class="updateuser-btn" value="修改用户信息">
      </form>
    </div>
  </div>
</template>
...
export default {
  ...
  methods:{
    closeUpdateUser: function() {
      this.$emit('UpdateUserSon', false);
    },
    ...
    submitUpdateUser: function() {
      ...
      // if(this.clazzId == ''){
      //   flag = false;
      //   console.log("clazzId:flag=",flag,"clazzId=",this.clazzId);
      // }
      if(this.role == ''){
        flag = false;
